...
def test_generate_md5_hash_from_string():
    ("utils.generate_md5_hash_from_string should return a dictionary with a hexadecimal hash")

    # Given a random string
    random_string = 'user@newstore.com'

    # When I call generate_md5_hash_from_string
    result = utils.generate_md5_hash_from_string(random_string)
...
def test_generate_uuid():
    ("utils.generate_uuid should return a hexadecimal hash")

    # Given a random string
    random_string = 'user@newstore.com'

    # When I call generate_md5_hash_from_string
    result = utils.generate_uuid(random_string)
...
def test_encrypt_password():
    ("utils.encrypt_password should return an encrypted pass hash")

    # Given a random password
    random_password = 'notagoodpass'

    # When I call generate_md5_hash_from_string
    result = utils.encrypt_password(random_password)
